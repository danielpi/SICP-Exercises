...
func parOne(a: EngineeringTolerance, b: EngineeringTolerance) -> EngineeringTolerance {
    return (a * b) / (a + b)
}

func parTwo(a: EngineeringTolerance, b: EngineeringTolerance) -> EngineeringTolerance {
