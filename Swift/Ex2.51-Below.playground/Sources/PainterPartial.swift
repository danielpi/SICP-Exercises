...
public func beside(left: @escaping Painter, _ right: @escaping Painter) -> Painter {
...
public func rotate90(painter: @escaping Painter) -> Painter {
    return transformPainter(painter: painter, origin:Point(x: 1, y: 0), corner1:Point(x: 1, y: 1), corner2:Point(x: 0, y: 0))
}

public func rotate180(painter: @escaping Painter) -> Painter {
    return transformPainter(painter: painter, origin:Point(x: 1, y: 1), corner1:Point(x: 0, y: 1), corner2:Point(x: 1, y: 0))
}

public func rotate270(painter: @escaping Painter) -> Painter {
