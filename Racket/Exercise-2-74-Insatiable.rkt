...
; The types will be the company division names (HR, Engineering, Production etc).
; The operations will be the 

(define (attach-tag type-tag contents)
  (cons type-tag contents))

(define (install-engineering-division)
