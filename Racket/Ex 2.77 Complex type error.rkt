...
; message from apply-generic, saying there is no method for the operation magnitude
; on types (complex). He shows this interaction to Alyssa P. Hacker, who says "The
...
; The z from Figure 2.24 has been tagged twice. But our data base of functions
; only has an entry for (magnitude z) if z is tagged with either 'polar or
; 'rectangular. By putting the command into the database again we give the
; dispatch system a way to identify that complex numbers have a magnitude.

; The procedures called in evaluating the expression (magnitude z) are
; (magnitude z)                  z = 'complex 'rectangular real imag
; (apply-generic 'magnitude z)
; strip the '(complex)
; (magnitude x)                  x = 'rectangular real imag
